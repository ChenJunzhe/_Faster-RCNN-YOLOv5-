...
# Load model
model = attempt_load('C:\\Users\\ChenJunzhe\\Desktop\\cs1.6\\FPSAutomaticAiming-main\\yolov5s.pt', map_location=device)  # load FP32 model
# model = attempt_load('C:\\Users\\ChenJunzhe\\Desktop\\cs1.6\\FPSAutomaticAiming-main\\runs\\train\\exp5\\weights\\best.pt', map_location=device)  # load FP32 model
